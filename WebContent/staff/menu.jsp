  ...
  <li class="nav-item">
            ...
            <li class="nav-item d-none d-lg-block">
              <a class="nav-link" data-toggle="collapse" href="#sidebar-layouts" aria-expanded="false" aria-controls="sidebar-layouts">
                ...
                <span class="menu-title">Manage Loan Type</span>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-advanced" aria-expanded="false" aria-controls="ui-advanced">
                ...
                <span class="menu-title">Manage Loan Request</span>
          ...
          <!--   
             <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">View Complaint </a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/forms/advanced_elements.html">Advanced Elements</a></li>
                  <li class="nav-item"><a class="nav-link" href="./validation.html">Validation</a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/forms/wizard.html">Wizard</a></li>
                </ul>
...
<!--                 <span class="badge badge-info">3</span> -->
            ...
            <!-- <li class="nav-item">
              ...
              <div class="collapse" id="charts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="adminResources/js/chartjs.html">ChartJs</a></li>
       ...
       <!--          <span class="badge badge-info">4</span> -->
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="./datatable.html">Data table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="adminResources/js/js-grid.html">Js-grid</a></li>
