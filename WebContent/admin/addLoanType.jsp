                  ...
                  <form class="cmxform" id="commentForm" method="get" action="#">
                    <fieldset>
                      <div class="form-group">
                        ...
                        <input id="cname" class="form-control" name="name" minlength="2" type="text" placeholder="Enter Loan Type" required>
                      </div>
                        
                        <div class="form-group">
                        <label for="ccomment">Loan description</label>
                        <textarea id="ccomment" rows="4"  class="form-control" name="comment" placeholder="Enter Loan Description" required></textarea>
                      </div>
