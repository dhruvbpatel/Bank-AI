					...
					<div class="section-part float-left">
						<div class="consultation-form-wrapper float-right col">
							<form action="#">
								...
								<input type="text" placeholder="Enter a first name" name="first_name">
									<label>last Name</label>
								<input type="text" placeholder="Enter a last name" name="last_name">
								<label>Mobile no</label>
								<input type="number" placeholder="Enter a mobile no" name="mb">
									<label>phone no</label>
								<input type="number" placeholder="Enter a phone no" name="ph">
							 ...
							 <textarea rows="5" cols="50" class="form-control" placeholder="Enter a address" name="address"></textarea>
									...
									<label>Pincode</label>
								<input type="number" placeholder="Enter a pincode" name="pincode">
									<label>Occupation</label>
								<input type="text" placeholder="occupation" name="occup">
