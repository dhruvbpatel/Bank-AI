			...
			<header class="theme-menu-wrapper">
				<div class="container">
					...
					<div class="header-wrapper clearfix">
						<!-- Logo -->
						<div class="logo float-left"><a href="index-2.html"><img src="userResources/images/logo/logo.png" alt="Logo"></a></div>
						...
						<nav class="theme-main-menu navbar float-right" id="mega-menu-wrapper">
						   ...
						   <div class="collapse navbar-collapse" id="navbar-collapse-1">
								<ul class="nav">
									<li class="dropdown-holder"><a href="index-2.html" class="tran3s">Home</a>
										<ul class="sub-menu">
											<li><a href="index-2.html">Home version one</a></li>
											<li><a href="index-3.html">Home version Two</a></li>
										</ul>
									</li>
									<li class="dropdown-holder active"><a href="#" class="tran3s">Services</a>
										<ul class="sub-menu">
				...
				<div class="container">
					<div class="top-footer row">
						<div class="col-md-4 col-sm-6 col-xs-12 footer-logo">
							...
							<p>We create business coaches and trainers, individual therapists, diet and nutrition consultants, as well as other specialists who need a personal website, Check our latest work in profile  . . . .</p>
							<h5>Follow us</h5>
							<ul>
								<li><a href="#" class="tran3s"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-2 col-sm-3 col-xs-12 footer-list">
							...
							<ul>
								...
								<li><a href="#" class="tran3s">Business Growth</a></li>
								<li><a href="project.html" class="tran3s">Project</a></li>
								<li><a href="#" class="tran3s">Case Study</a></li>
